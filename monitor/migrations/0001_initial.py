    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('alert_message', models.TextField(blank=True, default='[SWEETMON] New crash detected : __title__ / __description__', help_text='__title__ => Crash title, __description__ => Crash log', max_length=10000, null=True)),
